                                    ...
                                    <form action="" class="form-group" id="buscar1">
                                        <div class="modal-body">
                                            ...
                                            <div class="col-md-12 col-xs-12 col-sm-12">
                                                ...
                                                <textarea type="text" class="form-control redondeado inicialM" rows="3"
                                                    id="comentrioEmpleado" name="comentrioEmpleado" maxlength="600" required></textarea>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button class="btn btn-primary" id="btnCrearcomentarioDes"
                                                name="btnCrearcomentarioDes" data-bs-toggle="modal"> <i
