                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            ...
                            <form class="row g-3 form-group"
                                ...
                                <div class="col-md-8 col-xs-12 col-sm-12">
                                    ...
                                    <select class="form-control" id="usuarioCreacion" name="usuarioCreacion" aria-label="E"
                                ...
                                <div class="col-md-8 col-xs-12 col-sm-12">
                                    ...
                                    <select class="form-control" id="usuarioRevision" name="usuarioRevision" aria-label="E"
                                        aria-describedby="basic-addon1" required></select>
                                </div>
                                <div class="col-md-4 col-xs-12 col-sm-12">
                                ...
                                <div class="col-md-8 col-xs-12 col-sm-12">
                                    ...
                                    <select class="form-control" id="usuarioAprobacion" name="usuarioAprobacion" aria-label="E"
                                        aria-describedby="basic-addon1" required></select>
                                </div>
                                <div class="col-md-4 col-xs-12 col-sm-12">
                                ...
                                <div class="col-md-4 col-xs-12 col-sm-12">
                                    <button class="btn btn-primary" type="submit"><i class="fas fa-check"></i>Actualizar 
                                        Versión</button>
                                    <button type="reset" id="limpiar" name="limpiar" class="btn btn-secondary"><i class="fas fa-broom"></i>
                                        Limpiar</button>
                                </div>
                            </form>
                        </div>
