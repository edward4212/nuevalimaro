    ...
    function buscar() {
        $.ajax({
            ...
            $.each(json, function (key, value) {
                ...
                datos += '<td class=" border border-primary  text-center align-middle"><button type="button"  id="btnEstadiSolicitud" onclick="estadiSolicitud(' + value.id_solicitud + ',\'' + value.estado_solicitud + '\')" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#estadoSol"><i class="far fa-list-alt"></i></button></td>';
...
//             Swal.fire({
//                 icon: 'success',
//                 title: 'Revisión Registrada con Exito',
//                 showConfirmButton: false,
//                 timer: 3000
//             }).then((result) => {
//                 cargar();
...
//             Swal.fire({
//                 icon: 'success',
//                 title: 'Devolución de Documento Registrada con Exito',
//                 showConfirmButton: false,
//                 timer: 3000
//             }).then((result) => {
//                 cargar();
...
//             Swal.fire({
//                 icon: 'success',
//                 title: 'Aprobación Registrada con Exito',
//                 showConfirmButton: false,
//                 timer: 3000
//             }).then((result) => {
//                 cargar();
